...
const course = useSelector(
  (state: RootState) => state.courseReducer.currentCourse
);
  ...
  if (error || !course) {
    return (
      <div className="flex flex-col items-center py-24 text-center">
        <h2 className="mb-5 text-lg font-bold text-gray-500">
          {t("dataNotFound")}
        </h2>
    ...
    >
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <button className="rounded-xl bg-red-500 px-6 py-3 font-semibold text-white transition hover:bg-red-600 dark:bg-red-800 dark:hover:bg-red-700">
            {t("delete")}
          </button>
