...
function NotFound() {
  ...
  return (
    <>
      <div
        key={i18n.language}
        className="language-fade min-h-screen flex flex-col items-center justify-center gap-10 bg-white dark:bg-gray-900"
      >
        ...
        <div className="flex flex-col items-center bg-slate-200 p-10 rounded-2xl">
          ...
          <h2 className="text-4xl font-bold mt-4">{t("NotFoundPageTitle")}</h2>

          <p className="text-gray-500 text-center mt-3 max-w-lg">
            {t("NotFoundPageDesc")}
          </p>

          <div className="text-8xl mt-10 animate-bounce">🚀</div>
